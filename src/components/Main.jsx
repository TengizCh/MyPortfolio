...
const Main = () => {
  ...
  const icon = {
    hidden: {
      pathLength: 0,
      fill: "rgba(139, 49, 255, 0)",
    },
    visible: {
      pathLength: 1,
      fill: "rgba(139, 49, 255, 1)",
    },
  };
    ...
    >
      ...
      <div className="container">
        <div className="inner">
          ...
          <p className="my_name">Hi, My name is</p>
          <h1 className="username">Tengiz Charkviani</h1>
          <TypeAnimation
            sequence={[
              "I'm a skilled Web Developer",
              5000,
              "I design digital experiences for the web",
              5000,
              "I develop responsive web applications with a contemporary flair",
              5000,
            ]}
            speed={50}
            repeat={Infinity}
